...
public class Examples<K> extends Tester {
    ...
    void testNodeClass(Tester t) {
        ...
        Node<Integer, String> node99 = 
                new Node(5, "att", emptyNode, emptyNode, intComp, false);
        node99.include(4, "ver");
        MyMap<Integer, String> catNode = 
                new Node<Integer, String>(4, "Dave", emptyNode, 
                        emptyNode, intComp, false);
        MyMap<Integer, String> catNodeOrd = catNode.include(3, "Carol");
        MyMap<Integer, String> catNodeTest1 = 
                new Node<Integer, String>(1, "Alice", emptyNode, 
                        emptyNode, intComp, false);
        catNodeTest1 = catNodeTest1.include(2, "Bob");
        catNodeOrd = catNode.include(2, "Bob");
        catNodeOrd = catNode.include(1, "Alice");
        
        MyMap<Integer, String> catNodeUn = 
                new Node<Integer, String>(3, "Carol", emptyNode, 
                        emptyNode, intComp, false);
        ...
        MyMap<Integer, String> catNodeDub = 
                new Node<Integer, String>(1, "Alice", emptyNode, 
                        emptyNode, intComp, false);
        ...
        t.checkExpect(node99.equals(4), false);
        t.checkExpect(node99.equals(node99), true);
        t.checkExpect(node99.equals(kComp), false);
        t.checkExpect(node99.equals(null), false);
        ...
        t.checkExpect(map00.include(1, "f").set(4, "g"), map00.set(4, "g")
                .include(1, "f"));
        t.checkExpect(emptyNode.accept(null), emptyNode);
        t.checkExpect(node99.accept(null), node99);
    ...
    void testMyMapClass(Tester t) {
        ...
        try {
            ...
            t.checkExpect(rbtree.get(emptyNode, 1), true);
        }
        catch (Exception e) {
            System.out.println(
