...
public class Node<K, V> extends BST<K, V> {
    ...
    public int hashCode() {
        ...
        //else add it
            ...
            return hash * hakey + haval + 
                    l0.hashCode() + r0.hashCode();
    ...
    int hashHelp(int k) {
        ...
        //if (!l0.isEmpty()) {
            return this.l0.hashHelp(accum) + 1
                    + r0.hashHelp(accum);
        /*}
        else {
            return accum;
     ...
     */
    @SuppressWarnings("unchecked")
    K getRightChildValue() {
        return (K) ((Node<K, V>) r0).getValue();
    }
    /**
