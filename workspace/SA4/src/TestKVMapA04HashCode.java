...
/**
 * Testing Assignment 4 hashCode probability
 * 
 ...
 */
public class TestKVMapA04HashCode {
    ...
    public static void main(String[] args) {
        TestKVMapA04HashCode test = new TestKVMapA04HashCode();
