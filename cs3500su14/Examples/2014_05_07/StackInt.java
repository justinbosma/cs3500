...
public abstract class StackInt {
    ...
    public boolean equals(Object o) {
        if (o instanceof StackInt) {
            StackInt that = (StackInt) o;
            if (StackInt.size(this) == StackInt.size(that)) {
                if(StackInt.isEmpty(that)){
                    return true;
                }
                return (StackInt.top(this) == StackInt.top(that) && StackInt
                        .pop(this).equals(StackInt.pop(that)));
            }
            else {
                return false;
            }
