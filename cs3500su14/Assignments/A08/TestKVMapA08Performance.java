...
/**
 * Testing performance of KVMap for A07: Red-Black Tree (RBT) implementation
 * 
 * Modified from initial version by Will Clinger
 * 
 * @author Jessica Young Schmidt jschmidt
 */
public class TestKVMapA08Performance {
    ...
    public static void main(String args[]) {
        /** instance of TestKVMapA08Performance */
        TestKVMapA08Performance test = new TestKVMapA08Performance();
    ...
    private static class TimeAccept extends Benchmark {
        ...
        TimeAccept(KVMap<Foo, Double> m0, int n0, long iterations0) {
            this.m0 = m0;
            this.n0 = n0;
            this.iterations0 = iterations0;
        }
        ...
        long run(int n, long iters) {
            ...
            KVMapVisitor<Foo, Double> v = new KVMapVisitor<Foo, Double>() {
     ...
     * Timing m.containsKey(k)
     */
    private static class TimeContainsKeyAccept extends Benchmark {

        private final KVMap<Foo, Double> m0;

        TimeContainsKeyAccept(KVMap<Foo, Double> m0, int n0,
                long iterations0) {
            this.m0 = m0;
            this.n0 = n0;
            this.iterations0 = iterations0;
        ...
        boolean compareToExpected() {
            System.out.println();
            System.out
                    .println("m.accept(v).containsKey(k) benchmark ("
                            + iterations + " iterations): O(lg n)");
            System.out.println("    n=" + n + " in " + t1n + "ms");
            System.out.println("    n=" + (4 * n) + " in " + t4n
                    + "ms");
    ...
    private void performance() {
        ...
        assertTrue("accept(visitor) is O(n)", new TimeAccept(f0c, 64,
                1024 * 1024).run());
        assertTrue(
                "m.accept(v).containsKey(k) - containsKey O(log n)",
                new TimeContainsKeyAccept(f0c, 1, 1024 * 1024).run());
